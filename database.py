...
class Database:
        ...
        async with self.pool.acquire() as c:
            await c.execute("""
                CREATE TABLE IF NOT EXISTS users (
                    ...
                    vault NUMERIC(20,4) NOT NULL DEFAULT 0,
                    ...
                    bonus_received NUMERIC(20,4) NOT NULL DEFAULT 0,
                    losses NUMERIC(20,4) NOT NULL DEFAULT 0,
                    rakeback NUMERIC(20,4) NOT NULL DEFAULT 0,
                    rakeback_total NUMERIC(20,4) NOT NULL DEFAULT 0,
                    daily_at TIMESTAMPTZ,
                    weekly_at TIMESTAMPTZ,
                    monthly_at TIMESTAMPTZ,
                    lifetime_deposit NUMERIC(20,4) NOT NULL DEFAULT 0,
                ...
                if payout > 0:
                    ...
                    await c.execute(
                        ...
                        SET
                            ...
                            rakeback = rakeback + $3,
                            rakeback_total = rakeback_total + $3
                        WHERE user_id = $1
                        """,
                        user_id,
                        payout,
    ...
    async def top_wager_race(self, limit=3):
